function plot_fig11left_1cluster_nrods_grid_vel_xyplane
clc; clear all; clf
...
%             plot(xtemp(end),ytemp(end),'ro','markersize',6,'markerfacecolor','r'); hold on 
    ...
    x = [-D-1  D+1  D+1 -D-1]; 
    y = [-D-1 -D-1  D+1  D+1];
    patch(x,y,[0.9 0.9 0.9],'FaceAlpha',0.1)
